...
export const projectList = atom({
  ...
  { id: '2', name: 'BoT site', information: "Using NextJs/Typescript with DatoCMS we developed this website, Our goal was to make them a new site for the BoT game. We build components and auto generate their types with codegen and GraphQL, with help of blocks and models in datoCMS we can create fragments", netapp: 'https://www.mightanddelight.com/book-of-travels', img: MD },
